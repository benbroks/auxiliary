...
if __name__ == "__main__":
    ...
    base_cfms = np.load('confusionMatrices/base_cfms.npy',allow_pickle=True)
    print("Loaded CFMs.")
    x = []
    a_acc = []
    a_prec = []
